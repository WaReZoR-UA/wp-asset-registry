...
### Fixed
- Attachment downloads now send `Content-Disposition: attachment` so the "Download attachment" action saves the file instead of opening it inline in the browser tab.
